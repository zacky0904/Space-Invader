...
public class PlasmaBall extends Bullet {
	...
	public PlasmaBall( BULLET_LABLE label, Vector3f position, Vector3f velocity, float speed, float lifeTime) {
		super(LoadMaster.plasmaBall_TexturedModel, position, 0, (float)Math.random()*180f, 0, 0.4f, label, velocity, speed, lifeTime, 2);
